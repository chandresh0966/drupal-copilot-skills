...
- If a new field is added, is there a `hook_update_N` in the `.install` file to backfill existing data?
- If the update hook processes many entities (1000+), does it use direct DB queries instead of entity API load+save?
